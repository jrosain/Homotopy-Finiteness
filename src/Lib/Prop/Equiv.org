...
*** TODO \Pi_{x:A}B x and \Pi_{x: A'}B(e(x)) whenever A is equivalent to A'
    #+begin_src ctt
  ...
  Equiv/dependent/inv-map (A B : U) (P : B -> U) (e : Equiv A B) : ((x : A) -> P (Equiv/map A B e x)) -> (y : B) -> P y =
    \ h y. tr B
      ...
      ( Equiv/inv-right-htpy A B e y) P
      ( h (Equiv/inv-map A B e y))

  -- Equiv/dependent/inv-right-htpy (A B : U) (P : B -> U) (e : Equiv A B) (f : (x : A) -> P (Equiv/map A B e x))
  --                                     : Path ((x : A) -> P (Equiv/map A B e x))
  --                                            (Equiv/dependent/map A B P e (Equiv/dependent/inv-map A B P e f)) f =


  Equiv/dependent/left-htpy (A B : U) (P : B -> U) (e : Equiv A B) (f : (y : B) -> P y)
                                   : Path ((y : B) -> P y)
                                          (Equiv/dependent/inv-map A B P e (Equiv/dependent/map A B P e f)) f =
    eq-htpy B P
      ( Equiv/dependent/inv-map A B P e (Equiv/dependent/map A B P e f)) f
      ( \ y. apd B P f
            ( Equiv/map A B e (Equiv/inv-map A B e y)) y
            ( Equiv/inv-right-htpy A B e y))

  -- Equiv/dependent (A A' : U) (B : A -> U) (e : Equiv A A')
  --                       : Equiv ((x : A) -> B x) ((x : A') -> B (Equiv/inv-map A A' e x)) =
  --   let f : A' -> A = Equiv/inv-map A A' e in
