...
#+begin_src ctt
  ...
  lock ind-Set-trunc/Prop Set-trunc/Set Set/closed-Prod
  ...
  unlock ind-Set-trunc/Prop

  Set-trunc/prod/Equiv (A B : U) : Equiv (Set-trunc A * Set-trunc B) (Set-trunc (A * B)) =
    has-inverse/Equiv
      ( Set-trunc A * Set-trunc B)
      ( Set-trunc (A * B))
...
#+RESULTS:
: Typecheck has succeeded.
** TODO Mere eq and set truncation
