...
Successfully checked 3 definitions
Evaluation of \ A. \ B. \ A'. \ B'. \ f. \ g. ind-Coprod A B (\ _. Coprod A' B') (\ x. inl (f x)) (\ y. inr (g y))
Yields \ A. \ B. \ A'. \ B'. \ f. \ g. ind-Coprod A B (\ _. Coprod A' B') (\ x. inl (f x)) (\ y. inr (g y))
#+end_example
