...
#+begin_src ctt
  -- is-surjective/is-finite-codomain (A B : U) (H : is-finite A) (f : A -> B) (H' : is-surj A B f)
  --                                  (Heq : has-decidable-equality B) : is-finite B =
  --   rec-Prop-trunc
  --     ( (y : B) -> Fib A B f y)
  --     ( is-finite/Prop B)
  ...
  --     ( {- TODO: get the desired map from the surjection. -})
